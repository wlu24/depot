...
class Pago
  def self.make_payment(order_id:,
    ...
    # Part of Ruby’s standard library and provides a quick-and-dirty way to
    # make an object that responds to the methods given to its constructor.
    #
    # OpenStruct is handy for creating realistic objects from prototype or
    # faked-out code like Pago.
